...
public class appointmentDao {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			String sql = "insert into appointment (userId, fullName,gender,age,appoindate, email,phoNo, diseases,doctorId , address , status)values(?,?,?,?,?,?,?,?,?,?,?)";
